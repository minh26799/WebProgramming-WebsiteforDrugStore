...
<?php
  ...
  $pharmacyList = $pharmacy->getListPharmacy();
  // $row = $pharmacyList->fetch_assoc();
  $listRow = array();
  while($row = $pharmacyList->fetch_assoc()){
      ...
      <div class="row">
        <div class="col-sm-2">
          <div class="btn-group-vertical">
            <button type="button" class="btn btn-secondary btn-sm buttonMap" id="btn1">BK pharmacy</button>
            <button type="button" class="btn btn-secondary btn-sm buttonMap" id="btn2">Pharmacy 3/2</button>
            <button type="button" class="btn btn-secondary btn-sm buttonMap" id="btn3">DR. H</button>
